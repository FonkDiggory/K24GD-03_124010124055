...
public class TcpChatServer
{
    ...
    //    }
    //}
    //public static async Task <stringg >GetWebContent(string url)
    //{
    //    string html = "";
    //    try
    //    {
    //        var httpClient = new HttpClient();
    //        httpClient.DefaultRequestHeaders.Add("users-Agent")
    //    }
    //}
    string url = https://raw.githubusercontent.com/NTH-VTC/OnlineDemoC-/refs/heads/main/server_config.json
            try
            {
                ...
                httml = await httpresponse.Content.ReadAsStringAsync();
            }
